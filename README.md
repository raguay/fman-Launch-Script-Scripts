# fman-Launch-Script-Scripts

This is a repository of the different scripts I use with the [fman](http://fman.io) [LaunchScript plugin](https://github.com/raguay/LaunchScripts).
